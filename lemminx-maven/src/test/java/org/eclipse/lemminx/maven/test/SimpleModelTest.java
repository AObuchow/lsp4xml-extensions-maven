...
public class SimpleModelTest {
	...
	@Test
 	public void testPropertyHover() throws IOException, InterruptedException, ExecutionException, URISyntaxException {
 		...
 		connection.languageServer.getTextDocumentService().didOpen(params);
 		Hover hover;
 		TextDocumentPositionParams pos = new TextDocumentPositionParams( new TextDocumentIdentifier(textDocumentItem.getUri()), new Position(15, 17));
 		...
 		pos = new TextDocumentPositionParams( new TextDocumentIdentifier(textDocumentItem.getUri()), new Position(13, 35));
 	 	hover = connection.languageServer.getTextDocumentService().hover(pos).get();
 		assertNull(hover);
