...
public enum DependencyScope {
	...
	compile(org.apache.maven.artifact.Artifact.SCOPE_COMPILE,"This is the default scope, used if none is specified. Compile dependencies are available in all classpaths of a project. Furthermore, those dependencies are propagated to dependent projects."),
